...
all the type information which provides compile time safety later on.
As outlined in the structure below there are several steps
...
concise documentation of how an operation changes the types of the
